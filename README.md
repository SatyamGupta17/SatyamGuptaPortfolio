<h1 align="center">Backend/ AI Developer Portfolio</h1>
...
docker build -t My-Portfolio:dev -f Dockerfile.dev .

# Run the container
docker run -p 3000:3000 --name portfolio-dev My-Portfolio:dev
...
docker build -t My-Portfolio:prod -f Dockerfile.prod .

# Run the production container
docker run -p 3000:3000 --name portfolio-prod My-Portfolio:prod
```
...
export const personalData = {
  ...
  gfg: "https://gfg.com/yourusername",
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/SatyamGupta17/My-Portfolio)
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/SatyamGupta17/My-Portfolio)
...
docker build -t dMy-Portfolio:prod -f Dockerfile.prod .

# Run
docker run -d -p 80:3000 --name portfolio My-Portfolio:prod
...
- ⭐ [Star the repository](https://github.com/SatyamGupta17/My-Portfolio/stargazers)
- � [Report bugs](https://github.com/SatyamGupta17/My-Portfolio/issues)
- � [Suggest features](https://github.com/SatyamGupta17/My-Portfolio/discussions)

---

![GitHub stars](https://img.shields.io/github/stars/SatyamGupta17/My-Portfolio?style=social)
![GitHub forks](https://img.shields.io/github/forks/SatyamGupta17/My-Portfolio?style=social)
![GitHub issues](https://img.shields.io/github/issues/SatyamGupta17/My-Portfolio)
![GitHub license](https://img.shields.io/github/license/SatyamGupta17/My-Portfolio)
